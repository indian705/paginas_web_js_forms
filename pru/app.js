function main() {
    ...
    function validaText(oEv) {
        ...
        if (!element.checkValidity()) {
            ...
            if (element.validity.valueMissing) {
                ...
                msg = `El formato del ${element.id} debe ser 
                ${element.getAttribute('placeholder')}`
            } else if (element.validity.tooShort) {
                //msg = `El formato del ${element.id} es demasiado corto`
                msg = `El formato del ${element.id} debe ser de al menos 
                ${element.getAttribute('minlength')} caracteres`
            } else if (element.validity.tooLong) {
                //msg = `El formato del ${element.id} es demasiado largo`
                msg = `El formato del ${element.id} debe tener 
                ${element.getAttribute('maxlength')} caracteres como máximo`
            }
    ...
    function enviar(oEv) {
        if(checkInvalidInputs() ) {
            ...
            // Esto sobrari                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     pa para enviar realmente
            oEv.preventDefault()
